...
namespace Optimizasyon
{
    class Genetic
    {
        ...
        List<List<double>> distance = new List<List<double>>();         // for save distance between citys
        ...
        public Genetic(List<List<double>> distance_matrix, List<string> name, int itera, int pop, int crosssize, int mutsize)
        {
            this.distance = distance_matrix;
            this.name_citys = name;
            this.iteration = itera;
            this.corss_size = crosssize;
            this.population = pop;
            this.mut_size = mutsize;
        }
        ...
        {
            for (int count = 0; count < mut_size; count++)
            {
                Random r = new Random();
        ...
        {
            List<double> all_evalute_matrix = new List<double>();
            double x = 0;
            double num1;
            List<int> temp;
        ...
        void generate_lucky_matrix()
        {
            ...
            List<double> evalute_matrix = new List<double>();
            ...
            {
                double evalute = this.evalute_solution(this.main_solution[i]);
