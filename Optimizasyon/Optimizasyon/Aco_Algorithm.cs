...
namespace Optimizasyon
{
    class AcoAlgorithm
    {
        ...
        public AcoAlgorithm(List<List<int>> distance_matrix, List<string> name, int iteration,
        ...
        public void fermon_update()
        {
            ...
            int L = this.evalute_solution(this.main_solution);
